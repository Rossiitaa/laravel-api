...
var render = function render() {
  ...
  return _c("div", {
    staticClass: "card col-5 m-5"
  }, [_c("img", {
    staticClass: "card-img-top mt-3",
    attrs: {
      src: _vm.isValidUrl(_vm.post.image) ? _vm.post.image : "storage/" + _vm.post.image,
      alt: "image-post"
    }
  }), _vm._v(" "), _c("div", {
...
module.exports = __webpack_require__(/*! D:\Boolean-REPO\laravel-api\resources\js\front.js */"./resources/js/front.js");
